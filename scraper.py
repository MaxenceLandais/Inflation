...
from playwright_stealth import stealth_async  # Import direct
import requests
import json
from datetime import datetime
import re

# --- FONCTION ESSENCE (API GOUVERNEMENTALE) ---
def get_live_gas_price():
    ...
    try:
        ...
        data = response.json()
        # On extrait le prix moyen du SP95-E10
...
async def get_carrefour_price():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Attente d'un des sélecteurs de prix Carrefour
...
async def main():
    ...
    if produits_presents:
        ...
        print("Aucun prix n'a pu être collecté.")
